...
namespace blueprint::draw_node
{
    ...
    export using type_draw_operation = std::move_only_function<void(dyn_node::data_proxy &, data_draw_context)>;
    export using type_draw_map_t = std::unordered_map<dyn_node::id_type, type_draw_operation>;

    export using node_additional_draw_operation = std::move_only_function<void(dyn_node::node_instance_proxy)>;
